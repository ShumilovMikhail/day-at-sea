...
import { UsernameEditContainerComponent } from '@account/settings/username-edit';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, AuthEditUiComponent, UsernameEditContainerComponent, UiIndicatorsLoaderComponent],
